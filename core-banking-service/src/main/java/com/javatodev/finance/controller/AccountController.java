...
public class AccountController {
    ...
    @Operation(summary = "Get Account Transaction History", description = "Retrieve the transaction history for an account, optionally filtered by an inclusive date range, ordered most-recent-first")
    ...
    public ResponseEntity getAccountTransactions(
        ...
        log.info("Reading transaction history for account {} between {} and {}", accountNumber, fromDate, toDate);
        return ResponseEntity.ok(transactionService.getAccountTransactions(accountNumber, fromDate, toDate));
    }
